...
- imply sponsorship, endorsement or affiliation without authorization;
- represent AETHER X technology as technology developed or owned by another party;
- remove or falsify attribution from material where attribution is legally required;
- use AETHER X branding in a manner likely to create confusion as to source or ownership.
...
Access to additional information does not itself grant production, redistribution, sublicensing, source-transfer or ownership rights.
