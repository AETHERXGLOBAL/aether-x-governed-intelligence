...
class InstalledPackageTests(unittest.TestCase):
    def test_release_candidate_version(self) -> None:
        self.assertEqual(sdk.__version__, "0.1.0rc1")
        self.assertEqual(sdk.SDK_VERSION, "0.1.0rc1")
    ...
    def test_invalid_fixtures_fail_with_mapped_categories(self) -> None:
        cases = (
            (sdk.validate_eav, "reference-implementations/eav-contract-validator/examples/invalid_bundle.json"),
            (sdk.validate_point_in_time, "reference-implementations/point-in-time-knowledge-validator/examples/invalid_envelope.json"),
            (sdk.validate_agent_authority, "reference-implementations/agent-tool-authority-validator/examples/invalid_envelope.json"),
        )
    ...
    def test_unsupported_version_fails_explicitly(self) -> None:
        ...
        self.assertEqual(result.findings[0].source_code, "AX-SDK-RC-VERSION-UNSUPPORTED")
    ...
    def test_unsupported_contract_fails_explicitly(self) -> None:
        ...
        self.assertEqual(result.findings[0].source_code, "AX-SDK-RC-CONTRACT-UNSUPPORTED")
    ...
    def test_public_surface_contains_no_execution_capability(self) -> None:
        forbidden = {
            "execute",
            "authorize",
            "trade",
    ...
    def test_claim_boundary_remains_non_production(self) -> None:
        result = sdk.validate("AX-PUB-SPEC-999", {})
        self.assertIn("DOES NOT ESTABLISH PRODUCTION AUTHORITY", result.as_dict()["claim_boundary"])
